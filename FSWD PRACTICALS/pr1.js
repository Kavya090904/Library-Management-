...
const movies = [
    { title: "3 idiots", genre: "Comedy", rating: 8.3, releaseYear: 2009
    },
    { title: "chennai express", genre: "Action", rating: 6.2, releaseYear: 2013
    },
    ...
    addMovie(movies, { title: "Bhool Bhulaiyaa 2", genre: "Horror/Comedy", rating: 6.4, releaseYear: 2013
    });
    ...
    const findHighestRatedMovie = collection => {return collection.reduce((highest, movie) => movie.rating > highest.rating ? movie : highest);
    };
    ...
    console.log(`${movie.title} (${movie.releaseYear}) is a ${movie.genre} movie with a rating of
    ${movie.rating}.`);
    });    